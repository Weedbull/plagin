...
def main():
  ...
  plistpath = scriptpath + "/resources/bullplug-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/bullplug-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/bullplug-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/bullplug-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/bullplug-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/bullplug.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/bullplug.iss",inplace=1):
