...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=bullplug Demo Installer\n"
      else:
        line="OutputBaseFilename=bullplug Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the bullplug Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the bullplug installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=bullplug Demo installer\n"
     else:
       line="SetupWindowTitle=bullplug installer\n"
